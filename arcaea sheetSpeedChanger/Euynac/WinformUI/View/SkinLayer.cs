...
{
    public partial class SkinLayer : Form
    {
        private ControlLayer Main;
        public SkinLayer(ControlLayer main)
        {
            InitializeComponent();
            SetStyles();//减少闪烁
            Main = main;//获取控件层对象
            ...
            BackgroundImageLayout = ImageLayout.Zoom;//自动拉伸背景图以适应窗口
            Size = Main.Size;//统一大小
        ...
        public void setTransparentParent()
        {
